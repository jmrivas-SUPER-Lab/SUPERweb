...
```{r, eval=TRUE, echo=FALSE, out.width="75%", fig.align='center', fig.cap="Photograph of the 300 W wideband PA showing the (a) top-view and (b) bottom-view of the system."}
knitr::include_graphics("Tong_widbandphoto.jpg")
```
