---
title: "3-D-Printed Air-Core Inductors for High-Frequency Power Converters"
author: "W. Liang, L. Raymond and J. Rivas"
date: '2015-06-02'
slug: TPELS-3Dprinted-Inductors_Liang
categories:
  - Journal
  - IEEE TPELS
tags: 
  - 3D Printed Air Core Inductor
  - High Frequency Power Converters
  - Resonant Converters
  - Wei Liang
  - Luke Raymond
doi: '10.1109/TPEL.2015.2441005'
publishDate: '2015-06-02T00:00:00-01:00'
publication_types:
  - '1'
...
summary: 'This paper presents the design, modeling, and characterization of 3-D-printed air-core inductors for high-frequency power electronics circuits. The use of 3-D modeling techniques to make passive components extends the design flexibility and addresses some of the fabrication limitations of traditional processes. In this paper, we present several examples of air-core inductors realized using 3-D printing and casting/plating techniques to give an idea of the geometries that are possible to design. Toward this goal, we present a 70-W prototype 27.12-MHz resonant inverter that incorporates some of the 3-D-printed components developed for this paper.'
featured: yes
links:
- icon: doi
  icon_pack: ai
  name: Publication
  url: https://ieeexplore.ieee.org/document/7116563/
- icon: file-pdf
  icon_pack: fas
  name: Pre-print
  url: files2download/TPEL2016_paper_Wei.pdf
image:
  caption: ''
  placement: 2
  focal_point: 'Center'
...
```{r, eval=TRUE, echo=FALSE, out.width="75%", fig.align='center', fig.cap="Resonant inverter prototype photo."}
knitr::include_graphics("liang17-2441005-small.gif")
```
