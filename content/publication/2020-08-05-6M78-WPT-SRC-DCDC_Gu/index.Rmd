...
author: "L. Gu, G. Zulauf, A. Stein, P. A. Kyaw, T. Chen and J. M. R. Davila"
date: '2020-08-05'
slug: 6M78-WPT-SRC-DCDC_Gu
categories:
  - Journal
tags: 
  - Coupling Circuits
  ...
  - Grayson Zulauf
  - Tuofei Chen
doi: 'https://ieeexplore-ieee-org.stanford.idm.oclc.org/document/9159915'
publishDate: '2020-08-05T00:00:00-01:00'
publication_types:
  - '1'
...
- icon: doi
  icon_pack: ai
  name: Publication
  url: https://ieeexplore-ieee-org.stanford.idm.oclc.org/document/9159915
- icon: file-pdf
  icon_pack: fas
  name: Pre-print
  url: files2download/TPEL2020_paper_Lei.pdf
image:
  caption: ''
  placement: 2
  focal_point: 'Center'
...
```{r, eval=TRUE, echo=FALSE, out.width="75%", fig.align='center', fig.cap="Photograph of the PPT Φ2 wireless dc–dc converter. Coil diameter is 66.2 mm and the separation between the closest part of the coils is 19 mm. Implemented inverter dimensions are 7 cm × 7 cm × 1 cm. Diodes are integrated on coil output terminal for low parasitic inductance"}
knitr::include_graphics("gu6-3014042-small.gif")
```
