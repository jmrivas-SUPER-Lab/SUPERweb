---
title: "Design and Fabrication of Three-Dimensional Printed Air-Core Transformers for High-Frequency Power Applications"
author: "Z. Tong, W. D. Braun and J. M. Rivas-Davila"
date: '2020-01-06'
slug: 3D-AirCore-Xfm_Tong
categories:
  - Journal
tags: 
...
```{r, eval=TRUE, echo=FALSE, out.width="75%", fig.align='center', fig.cap="(a) Measured drain and gate waveforms of the inverter, (b) diode waveforms of the rectifier, and (c) photographs of the full systems implementing (from top to bottom) the nested transformer, stacked transformer, and interleaved 3-D printed transformer."}
knitr::include_graphics("tong29-2963976-small.gif")
```
