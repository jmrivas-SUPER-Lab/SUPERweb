...
```{r, eval=TRUE, echo=FALSE, out.width="75%", fig.align='center', fig.cap="A photo of the hardware implementation of the proposed computing circuit with a US penny for scale. The active area of the circuit is shown in color and measures 3.925 × 0.535 inches."}
knitr::include_graphics("poon21-analog-circuit.jpg")
```
