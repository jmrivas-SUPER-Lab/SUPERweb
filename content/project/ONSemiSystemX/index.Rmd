...
```{r, eval=TRUE, echo=FALSE, out.width="75%", fig.align='center', fig.cap="Simulated Coss loss energy dissipation per soft-switching cycle at 400 V across various trap energy levels (ΔET ) from 0.4 to 0.98 eV. Trap concentration constant at 2e16 cm−3. The dashed lines are measured Coss losses under 400VDS as reference."}
knitr::include_graphics("zhuan9-3063062-small.gif")
```
