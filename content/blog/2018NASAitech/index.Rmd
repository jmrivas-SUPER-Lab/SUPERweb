...
```{r, eval=TRUE, echo=FALSE, out.width="75%", fig.align='center', fig.cap="Grayson Zulauf (third from left) is an EE PhD candidate. He is a researcher in the SUPERLab, directed by Professor Juan Rivas-Davila. the Fan Lab is directed by professor Jonathan Fan."}
...
blogdown::shortcode("youtube", "5J4ujYLPO24")
```
https://youtu.be/5J4ujYLPO24
