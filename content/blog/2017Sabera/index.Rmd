...
layout: single
subtitle: Sabera J. Talukder on her research an academic experience
title: SUPER-Lab undergrad intern featured in Stanford EE Spotligh
---


```{r, eval=TRUE, echo=FALSE, out.width="75%", fig.align='center', fig.cap="Sabera J. Talukder"}
knitr::include_graphics("SaberaTalukder.jpg")
```
...
I believe the electrostatic precipitator has the capability of helping the 4.3 million people a year that die from respiratory diseases,
Professor Rivas is the most encouraging and supportive professor, and has always supported me even when he did not necessarily believe that something I was doing was possible
The Ph.D students in Professor Rivas' lab are all incredibly kind, helpful and believed in what I was doing even when I was doubtful.
